...
import com.openmove.aroundsardinia.UserCheckRequestUser;
...
public class UserCheckRequest {
  ...
  @SerializedName("user")
  private UserCheckRequestUser user = null;

  /**
   **/
  @ApiModelProperty(required = true, value = "")
  public UserCheckRequestUser getUser() {
    return user;
  }
  public void setUser(UserCheckRequestUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserCheckRequest userCheckRequest = (UserCheckRequest) o;
    return (this.user == null ? userCheckRequest.user == null : this.user.equals(userCheckRequest.user));
  }
  ...
  public String toString()  {
    ...
    sb.append("class UserCheckRequest {\n");
