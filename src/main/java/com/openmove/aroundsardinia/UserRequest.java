...
import com.openmove.aroundsardinia.UserRequestUser;
...
public class UserRequest {
  ...
  @SerializedName("user")
  private UserRequestUser user = null;

  /**
   **/
  @ApiModelProperty(required = true, value = "")
  public UserRequestUser getUser() {
    return user;
  }
  public void setUser(UserRequestUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.user == null ? userRequest.user == null : this.user.equals(userRequest.user));
  }
