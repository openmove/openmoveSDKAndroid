...
public class Body6 {
  ...
  public boolean equals(Object o) {
    ...
    Body6 body6 = (Body6) o;
    return (this.agency == null ? body6.agency == null : this.agency.equals(body6.agency)) &&
        (this.location == null ? body6.location == null : this.location.equals(body6.location)) &&
        (this.radius == null ? body6.radius == null : this.radius.equals(body6.radius)) &&
        (this.limit == null ? body6.limit == null : this.limit.equals(body6.limit));
  }
