...
public class TripsreserveUser {
  ...
  public boolean equals(Object o) {
    ...
    TripsreserveUser tripsreserveUser = (TripsreserveUser) o;
    return (this.name == null ? tripsreserveUser.name == null : this.name.equals(tripsreserveUser.name)) &&
        (this.surname == null ? tripsreserveUser.surname == null : this.surname.equals(tripsreserveUser.surname)) &&
        (this.nationality == null ? tripsreserveUser.nationality == null : this.nationality.equals(tripsreserveUser.nationality)) &&
        (this.email == null ? tripsreserveUser.email == null : this.email.equals(tripsreserveUser.email)) &&
        (this.phone == null ? tripsreserveUser.phone == null : this.phone.equals(tripsreserveUser.phone)) &&
        (this.tnc == null ? tripsreserveUser.tnc == null : this.tnc.equals(tripsreserveUser.tnc)) &&
        (this.commercial == null ? tripsreserveUser.commercial == null : this.commercial.equals(tripsreserveUser.commercial));
  }
  ...
  public String toString()  {
    ...
    sb.append("class TripsreserveUser {\n");
