...
import com.openmove.aroundsardinia.UserProfileRequestUser;
...
public class UserProfileRequest {
  ...
  @SerializedName("user")
  private UserProfileRequestUser user = null;

  /**
   **/
  @ApiModelProperty(required = true, value = "")
  public UserProfileRequestUser getUser() {
    return user;
  }
  public void setUser(UserProfileRequestUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.user == null ? userProfileRequest.user == null : this.user.equals(userProfileRequest.user));
  }
